...
source: https://zan.gov.kz/client/#!/doc/153532/kaz/10.03.2021
---
...
41. "Б" корпусының қызметшісін бағалау нәтижелерімен таныстыру жазбаша түрде жүргізіледі. Қызметші танысудан бас тартқан жағдайда, еркін түрде акт құрылып, құрылымдық бөлімше басшысымен және мемлекеттік органның басқа екі қызметшілерімен қол қойылған акт толтырылады.
