...
source: https://zan.gov.kz/client/#!/doc/147708/rus/14.10.2020
---
...
42. Отказ служащего корпуса «Б» от ознакомления не является препятствием для внесения результатов оценки в его послужной список. В данном случае руководителем структурного подразделения результаты оценки служащего корпуса «Б» направляются посредством интранет - портала государственных органов.
