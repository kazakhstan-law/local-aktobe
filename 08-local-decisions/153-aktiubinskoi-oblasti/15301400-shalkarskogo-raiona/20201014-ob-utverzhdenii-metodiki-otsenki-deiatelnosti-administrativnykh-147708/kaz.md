...
source: https://zan.gov.kz/client/#!/doc/147708/kaz/14.10.2020
---
...
41. «Б» корпусының қызметшісін бағалау нәтижелерімен таныстыру жазбаша түрде жүргізіледі. Қызметші танысудан бас тартқан жағдайда, еркін түрде акт құрылып, құрылымдық бөлімше басшысымен және мемлекеттік органның басқа екі қызметшісімен қол қойылады.

42. «Б» корпусы қызметшісінің танысудан бас тартуы бағалау нәтижелерін оның қызметтік тізіміне енгізуге кедергі болмайды. Бұл жағдайда құрылымдық бөлімше басшысымен «Б» корпусы қызметшісінің бағалау нәтижесін мемлекеттік органдардың интранет-порталы арқылы жолданады.
