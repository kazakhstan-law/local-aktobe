...
source: https://zan.gov.kz/client/#!/doc/158423/rus/27.08.2021
---
...
42. Отказ служащего корпуса «Б» от ознакомления не является препятствием для внесения результатов оценки в его послужной список. В данном случае главным специалистом результаты оценки служащего корпуса «Б» направляются посредством интранет - портала государственных органов.
