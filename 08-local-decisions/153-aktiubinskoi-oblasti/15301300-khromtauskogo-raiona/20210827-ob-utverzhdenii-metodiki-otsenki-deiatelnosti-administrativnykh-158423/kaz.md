---
version_id: '158423_537972'
act_code: '158423'
language: kaz
title: «Хромтау аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалау әдістемесін бекіту туралы
requisite: Ақтөбе облысы Хромтау аудандық мәслихатының 2021 жылғы 27 тамыздағы № 89 шешімі. Күші жойылды - Ақтөбе облысы Хромтау аудандық мәслихатының 2025 жылғы 4 шілдедегі № 330 (алғашқы ресми жарияланған күнінен бастап қолданысқа енгізіледі) шешімімен
form: РЕШ
type_codes:
- МЕТ
- РЕШ
...
registry_number: '158423'
source: https://zan.gov.kz/client/#!/doc/158423/kaz/27.08.2021
---

# «Хромтау аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалау әдістемесін бекіту туралы
...
1. Қоса беріліп отырған «Хромтау аудандық мәслихатының аппараты» мемлекеттік мекемесінің «Б» корпусы мемлекеттік әкімшілік қызметшілерінің қызметін бағалау әдістемесі бекітілсін.
...
> *2021 жылғы «27» тамызда*  
> *№ 89 шешімімен бекітілсін*
...
8. Бағалауға байланысты құжаттар бағалау аяқталғаннан кейін, функционалдық міндеттеріне кадр қызметінің жұмысын жүргізуі кіретін мәслихат аппаратының бас маманында (бұдан әрі – бас маман) үш жыл бойы сақталады.
...
25. Құзыреттерді бағалау тікелей басшымен жүргізіледі және оның нәтижесі бойынша Үлгілік әдістемесінің 3 қосымшасына сәйкес нысан бойынша бағалау парағы толтырылады.
...
41. «Б» корпусының қызметшісін бағалау нәтижелерімен таныстыру жазбаша түрде жүргізіледі. Қызметші танысудан бас тартқан жағдайда, еркін түрде акт құрылып, бас мамананымен және мемлекеттік органның басқа екі қызметшісімен қол қойылады.

42. «Б» корпусы қызметшісінің танысудан бас тартуы бағалау нәтижелерін оның қызметтік тізіміне енгізуге кедергі болмайды. Бұл жағдайда бас маманымен «Б» корпусы қызметшісінің бағалау нәтижесін мемлекеттік органдардың интранет-порталы арқылы жолданады.
