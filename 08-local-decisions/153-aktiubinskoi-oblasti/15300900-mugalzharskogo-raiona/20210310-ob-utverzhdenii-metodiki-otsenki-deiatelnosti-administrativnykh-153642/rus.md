...
source: https://zan.gov.kz/client/#!/doc/153642/rus/10.03.2021
---
...
5. Для проведения оценки должностным лицом, имеющим право назначения на государственную должность и освобождения от государственной должности служащего корпуса «Б» (далее – уполномоченное лицо), создается Комиссия по оценке (далее – Комиссия), рабочим органом которой является структурное подразделение аппарата маслихата, в функциональные обязанности которого входит ведение кадровой работы.
