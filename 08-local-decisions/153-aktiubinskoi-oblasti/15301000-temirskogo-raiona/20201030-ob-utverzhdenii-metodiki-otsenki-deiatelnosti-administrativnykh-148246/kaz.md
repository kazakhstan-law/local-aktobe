...
source: https://zan.gov.kz/client/#!/doc/148246/kaz/30.10.2020
---
...
41. «Б» корпусының қызметшісін бағалау нәтижелерімен таныстыру жазбаша түрде жүргізіледі. Қызметші танысудан бас тартқан жағдайда, еркін түрде акт құрылып, бас маманымен және мемлекеттік органның басқа екі қызметшілерімен қол қойылған акт толтырылады.

42. «Б» корпусы қызметшісінің танысудан бас тартуы бағалау нәтижелерін оның қызметтік тізіміне енгізуге кедергі болмайды. Бұл жағдайда бас маманымен «Б» корпусы қызметшісінің бағалау нәтижесі мемлекеттік органдардың интранет–порталы арқылы жолданады.
